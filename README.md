...
2. Install the Analytics.js code as described in the [Segment.io documentation](https://segment.com/docs/libraries/analytics.js/quickstart/).
...
``` $analytics->track($track, $js = true, $js_options = array(), $js_callback = null); ```
